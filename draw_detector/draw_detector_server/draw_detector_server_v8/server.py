...
async def get_config() -> JSONResponse:
    """Return drawing surface settings needed by the tablet UI."""
    return JSONResponse({
        "canvas_aspect_w": config.CANVAS_ASPECT_W,
        "canvas_aspect_h": config.CANVAS_ASPECT_H,
    })
...
async def detect(req: DetectRequest) -> JSONResponse:
    ...
    payload: Dict[str, Any] = {
        ...
        "canvas_aspect": [config.CANVAS_ASPECT_W, config.CANVAS_ASPECT_H],
