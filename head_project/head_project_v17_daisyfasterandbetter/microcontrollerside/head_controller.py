...
class HeadController:
    ...
    def __init__(
        ...
        pan_target_tolerance_deg=0.5,
        pan_min_command_change_deg=0.2,
        ...
        tilt_down_max_speed_deg_s=None,
        tilt_down_acceleration_deg_s2=None,
        tilt_target_tolerance_deg=0.6,
        tilt_min_command_change_deg=0.25,
    ):
        ...
        self.pan_servo = ServoController(
            ...
            target_tolerance_deg=pan_target_tolerance_deg,
            min_command_change_deg=pan_min_command_change_deg,
        )
        ...
        self.tilt_servo = ServoController(
            ...
            # In this mechanism, decreasing the tilt angle is the physical
            # downward direction. It therefore gets its own gentler limits.
            negative_max_speed_deg_s=tilt_down_max_speed_deg_s,
            negative_acceleration_deg_s2=tilt_down_acceleration_deg_s2,
            target_tolerance_deg=tilt_target_tolerance_deg,
            min_command_change_deg=tilt_min_command_change_deg,
        )
