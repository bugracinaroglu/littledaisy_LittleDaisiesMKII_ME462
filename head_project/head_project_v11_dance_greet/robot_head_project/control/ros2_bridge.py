...
class Ros2CommandBridge:
    """Optional ROS2 bridge using only standard message packages.

    String payload examples:
      /robot_head/face:     "SIGMA,4000"
      /robot_head/gesture:  "NOD,2,0"
      /robot_head/gesture:  "SUNGLASSES_NOD,2,4000"
      /robot_head/gesture:  "SIGMA_NOD,3,5000"
      /robot_head/gesture:  "DANCE,3,7000"
      /robot_head/gesture:  "GREET,2,7000"
      /robot_head/gesture:  "DAISY_DANCE,3,8000"
    """
