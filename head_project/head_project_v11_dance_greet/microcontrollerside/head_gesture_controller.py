...
class HeadGestureController:
    ...
    def __init__(
        ...
        dance_pan_offset_deg=14.0,
        dance_tilt_up_offset_deg=5.0,
        dance_tilt_down_offset_deg=-5.0,
        dance_dwell_ms=150,
        greet_pan_offset_deg=20.0,
        greet_nod_up_offset_deg=5.0,
        greet_nod_down_offset_deg=-5.0,
    ...
    def start(self, name, count=None):
        ...
        elif name == "DAISY_DANCE" and self.arms is not None:
            self.arms.start_dance(repeat_count)
    ...
    def cancel(self, hold_position=True):
        ...
        if cancelled_name == "DAISY_DANCE" and self.arms is not None:
            self.arms.center()
