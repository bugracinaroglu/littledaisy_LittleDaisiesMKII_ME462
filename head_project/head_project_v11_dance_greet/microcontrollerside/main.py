...
def init_head_controller():
    return HeadController(
        ...
        pan_move_interval_ms=HEAD_PAN_MOVE_INTERVAL_MS,
        ...
        tilt_move_interval_ms=HEAD_TILT_MOVE_INTERVAL_MS,
    )
...
def run():
    ...
    try:
        ...
        print("HEAD_POSE:90,40 | HEAD_PAN:90 | HEAD_TILT:40")
        print("FACE:SIGMA,4000 | FACE:SUNGLASSES,4000")
        print("GESTURE:NOD,2,0")
        print("GESTURE:SUNGLASSES_NOD,2,4000")
        print("GESTURE:SIGMA_NOD,2,4000")
        print("GESTURE:SHAKE,2,0 | GESTURE:LOOK_AROUND,1,0")
        print("GESTURE:CELEBRATE,2,3000")
        print("GESTURE:DANCE,3,7000 | GESTURE:GREET,2,7000")
        ...
        while True:
            ...
            face_locked = is_face_locked(face_state)
            gesture_active = gestures is not None and gestures.is_active()
