...
class Visualizer:
    ...
    def draw_control(self, frame, mapping_result, serial_connected):
        ...
        servo_direction = mapping_result.get("servo_direction", 1)
        control_reverse_x = mapping_result.get("control_reverse_x", False)
        ...
        self.draw_text_box(
            frame,
            f"Servo dir: {servo_direction} | Reverse X: {control_reverse_x}",
            (30, 650),
            bg=(50, 50, 50),
            scale=0.60
        )
