...
STATUS_PAN_GEAR_REVERSES_DIRECTION = True
...
# ROS: ROS2 topic/service commands are accepted.
STARTUP_CONTROL_MODE = "AUTO"

# Keep this False until rclpy and the standard ROS2 message packages are
# available in the runtime environment. The bridge can then be enabled without
# changing the rest of the controller.
ENABLE_ROS2_BRIDGE = False
ROS2_NODE_NAME = "robot_head_bridge"
