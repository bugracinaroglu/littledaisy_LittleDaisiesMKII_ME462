...
HEAD_PAN_MAX_SPEED_DEG_S = 100.0
HEAD_PAN_ACCEL_DEG_S2 = 240.0
HEAD_PAN_MOTION_UPDATE_INTERVAL_MS = 20
HEAD_PAN_TARGET_TOLERANCE_DEG = 0.35
HEAD_PAN_MIN_COMMAND_CHANGE_DEG = 0.15
...
HEAD_TILT_NEUTRAL_ANGLE = 98
HEAD_TILT_MIN_LIMIT_ANGLE = 75.0
HEAD_TILT_MAX_LIMIT_ANGLE = 120
# General upward/positive-angle limits.
HEAD_TILT_MAX_SPEED_DEG_S = 65.0
HEAD_TILT_ACCEL_DEG_S2 = 150.0

# Decreasing angle is the physical downward direction on this mechanism.
# It is deliberately slower and softer because this is where the loaded tilt
# servo was observed to vibrate during DANCE and GREET.
...
# Moving gestures first travel to the measured neutral pose and only then
# start their choreography. This makes repeated calls deterministic.
