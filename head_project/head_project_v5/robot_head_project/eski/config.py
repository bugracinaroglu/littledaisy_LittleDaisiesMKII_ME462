...
DEFISH_OUTPUT_DIAGONAL_FOV_DEG = 160
...
CAMERA_MOUNT_MODE = "head_mounted"     # "fixed" "head_mounted"
...
ERROR_SMOOTHING_ALPHA = 0.55

SEND_INTERVAL_SEC = 0.03
MIN_ANGLE_CHANGE_TO_SEND = 0.9
MAX_TARGET_STEP_PER_SEND = 1.5
