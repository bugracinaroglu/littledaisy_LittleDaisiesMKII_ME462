...
def main():
    ...
    camera = Camera(
        ...
        fisheye_crop_scale=FISHEYE_CROP_SCALE,

        defish_input_diagonal_fov_deg=DEFISH_INPUT_DIAGONAL_FOV_DEG,
        defish_output_diagonal_fov_deg=DEFISH_OUTPUT_DIAGONAL_FOV_DEG,
        defish_strength=DEFISH_STRENGTH,
        defish_zoom=DEFISH_ZOOM,

        fisheye_camera_matrix=FISHEYE_CAMERA_MATRIX,
        fisheye_dist_coeffs=FISHEYE_DIST_COEFFS,
    ...
    if not camera.is_opened():
        ...
        print("Check CAMERA_BACKEND, CAMERA_INDEX, or Picamera2 installation.")
        return  
    ...
    head_mapper = HeadAngleMapper(
        ...
        head_mounted_gain=HEAD_MOUNTED_GAIN,
        head_mounted_min_step_deg=HEAD_MOUNTED_MIN_STEP_DEG,
        head_mounted_max_step_deg=HEAD_MOUNTED_MAX_STEP_DEG
    )
