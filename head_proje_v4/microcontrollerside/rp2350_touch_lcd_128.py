...
class QMI8658(object):
    def __init__(self,address=0X6B):
        ...
        if bRet :
            ...
            raise OSError("QMI8658 not detected")
        self.Config_apply()
    ...
    def Read_Raw_XYZ(self):
        ...
        for i in range(6):
            ...
            xyz[i] = self._to_signed_16bit(value)
        return xyz
    def Read_XYZ(self):
        xyz = [0, 0, 0, 0, 0, 0]
        raw_xyz = self.Read_Raw_XYZ()
        
        # QMI8658AccRange_8g → 4096 LSB/g
        acc_lsb_div = 4096.0
        # QMI8658GyrRange_512dps → 64 LSB/dps
        gyro_lsb_div = 64.0

        for i in range(3):
            xyz[i] = raw_xyz[i] / acc_lsb_div * 9.80665  # g'den m/s²'ye çevir
